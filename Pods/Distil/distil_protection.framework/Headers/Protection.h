...
/**
 ...
 @param protectionEndpoint
    The server endpoint used to obtain tokens.
    Example: https://api.example.com
 @return A `Protection` instance that can be used to obtain a token.
*/
- (nonnull id)initWithProtectionEndpoint:(nonnull NSURL*)protectionEndpoint;
...
/**
 ...
 @return A `Protection` instance that can be used to obtain a token.
 */
- (nonnull id)initWithProtectionEndpoint:(nonnull NSURL*)protectionEndpoint debugKey:(nonnull NSString*) debugKey;
#endif
